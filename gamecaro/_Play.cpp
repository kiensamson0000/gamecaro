...
void About()
{
	...
	cout << "PROJECT GAME CO CARO - COPYRIGHT © DAI HOC CONG NGHIEP HA NOI" << endl;
	_Common::gotoXY(50, 22);
	cout << "-> MSSV   : 2017605250" << endl;
	_Common::gotoXY(50, 23);
	cout << "-> HO TEN : KHUAT HUY KIEN." << endl;
	_Common::gotoXY(50, 24);
	cout << "-> LOP    : KTPM3-K12." << endl;
	_Common::gotoXY(50, 25);
	cout << "-> CHUC MOI NGUOI CHOI GAME VUI VE !!!" << endl;
	_Common::gotoXY(60, 29);
	cout << "BACK";
	char command = ' ';
	command = _getch();			
	system("cls");
